...
// - c1_s03_entry_decision: Einsteigen oder Rennen?
...
Aber du weißt: Du wartest auf etwas.`,
  ...
  'c1_s02_train_appears': {
    ...
    chapter: 1,
    title: 'Der Zug',
    narrative: `Ein Geräusch. Nicht das Rattern von Schienen, sondern ein tiefes Brummen, das du mehr im Brustkorb spürst als hörst.
...
Durch die Scheiben siehst du Silhouetten – Menschen, die reglos auf ihren Plätzen sitzen.`,
    choices: [
      {
...
Zur Rechten: Ein leeres Abteil mit einem Koffer auf dem Sitz. Niemand in der Nähe.`,
    choices: [
      {
        id: 'talk_to_man',
...
Du sagst nichts.`,
    ...
    tags: ['station_end'],
    state_notes: [
      'Erste station_end-Szene: memory_drift wird automatisch erhöht',
      'Callback: Jackenfarbe ändert sich (Drift-Effekt)',
